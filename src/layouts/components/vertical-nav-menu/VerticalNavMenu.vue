      ...
      <div @mouseenter="mouseEnter" @mouseleave="mouseLeave">
        ...
        <div class="header-sidebar flex items-end justify-between" slot="header">
          ...
          <router-link tag="div" class="vx-logo cursor-pointer flex items-center" to="/">
            ...
            <span class="vx-logo-text text-primary" v-show="isMouseEnter || !reduce" v-if="title">Chatbot</span>
          </router-link>
          <!-- /Logo -->
        ...
        <!-- Menu Items -->
        <component 
        :is="scrollbarTag" ref="verticalNavMenuPs" class="scroll-area-v-nav-menu pt-2" :settings="settings" @ps-scroll-y="psSectionScroll" @scroll="psSectionScroll" :key="$vs.rtl">
