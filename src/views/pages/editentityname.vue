      ...
      <vx-card title="Update Entity">
        ...
        <div class="vx-row">
          <div class="vx-col w-full">
            <vs-button  v-on:keyup.enter="Update"  :disabled="!validateForm"  @click="Update" class="mr-3 mb-2" >Update</vs-button>
...
components: {
  ...
  computed: {
    validateForm () {
      return !this.errors.any() && this.rowdata[0].entitykey.length >0 && this.rowdata[0].entityvalue.length >0 
    }
  },
  mounted () {
      const url =Base_URL.Actual_URL+'editentityname/'
     //const url='http://127.0.0.1:5000/editentityname/'
  ...
  methods: {
   Update() {
      ...
      this.$vs.notify({ title: 'Edit Entity ', text: 'Your Entity data is updated', color, position: 'top-center' })
